  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: 'welcome-msg',
      role: 'model',
      text: `مرحباً بك يا **${userName || 'شريكي المالي'}** في **المستشار المالي الذكي**! 👋\n\nأنا مستشارك المالي المخصص المدعوم بذكاء **Gemini AI**. لقد قمت بمراجعة بياناتك المالية الحالية وسجل مشاريعك وديونك.\n\nيمكنني مساعدتك في:\n- **تحليل الوضع المالي الشامل** وتقديم نصائح ادخار ذكية.\n- **وضع خطط مخصصة لسداد ديونك** بأسرع وقت وأقل جهد.\n- **مراقبة سقف ميزانيات مشاريعك** والتنبيه عند اقتراب الخطر.\n\nاضغط على أحد الأسئلة المقترحة بالأسفل أو اكتب لي أي سؤال يخطر ببالك وسأجيبك فوراً! 📊✨`,
      timestamp: new Date()
    }
  ]);
  ...
  const handleSendMessage = async (textToSend: string) => {
    ...
    try {
      ...
      const errorMsg: Message = {
        id: `ai-err-${Date.now()}`,
        role: 'model',
        text: '⚠️ عذراً، حدث خطأ أثناء الاتصال بالمستشار المالي الذكي. يرجى التحقق من توفر اتصال بالشبكة وتكوين مفتاح API الخاص بـ Gemini في الإعدادات.',
        timestamp: new Date()
      };
      ...
      <div className="bg-gradient-to-r from-sky-900 to-indigo-950 p-6 md:p-8 rounded-3xl text-white shadow-md relative overflow-hidden flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
        ...
        <div className="space-y-2 text-right relative z-10 max-w-2xl">
          <div className="inline-flex items-center gap-1.5 bg-sky-500/20 text-sky-300 px-3 py-1 rounded-full text-[11px] font-black border border-sky-400/20">
            ...
            <span>مدعوم بـ Gemini AI الذكي</span>
          </div>
